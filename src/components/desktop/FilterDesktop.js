...
function FilterDesktop({test, sortBy,setSortBy, marka,setMarka,}) {

  return (
    <div className='mb-5 pb-5 pb-5 row filters'>
      <h5 className='filtersh1'> <BiFilterAlt size={22}></BiFilterAlt> Szűrők</h5>
      <div className='row m-0 p-0'>
        <div className='col-lg-12 p-0'>
          <select id="filter" defaultValue={sortBy} onChange={(e)=>test(e)}>
